...
print("Running in CI: {}".format(isCI))
...
# File Set
exceptional_files = {'README.rst', 'CHANGELOG.md', 'LICENSE', 'CONTRIBUTING.md'}

parser = argparse.ArgumentParser(prog="JobStatusChecker",
                                 description="Check Job Stati of a specific github workflow run")
